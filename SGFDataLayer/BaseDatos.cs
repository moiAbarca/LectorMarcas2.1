    ...
    public class BaseDatos
    {
        ...
        private void Configurar()
        {
            try
            {
                ...
                this.cadenaConexion = String.Format("Server={0};Database={1};Uid={2};Pwd={3};Port={4};", server, database, user, password, port);
        ...
        #region
        public void AsignarParametroChar(string nombre, char valor)
        {
            AsignarParametro(nombre, "", valor.ToString());
        }
        #endregion
        ...
        /// </summary>
        /// <param name="nombre">E"l nombre del parámetro.</param>
        /// <param name="valor">El valor del parámetro.</param>
        ...
        //asigna un parámetro del tipo foto al comando creado
        #region

        
        public void AsignarParametroFoto(string nombre, string valor)
        {
            AsignarParametro(nombre, "'", valor.ToString());
            
            /* MemoryStream msByte = new MemoryStream(valor);
            MemoryStream msFoto = new MemoryStream();
            Foto.Save(msFoto, ImageFormat.Jpeg);
            */
        }
